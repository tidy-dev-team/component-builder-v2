...
export function validateAgainstSecurity(input: string): boolean {
  const { xssPattern, sqlInjectionPattern, pathTraversalPattern, nullBytePattern, maxInputLength } = securityRules;
